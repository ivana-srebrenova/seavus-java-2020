...
insert into note (id, title, content, user_Id) values (101, 'SeavusTalent', 'Exercises', 101);
insert into note (id, title, content, user_Id) values (102, 'SpringBoot', 'Application', 102);
